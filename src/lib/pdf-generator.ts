...
export const generateCertificatePDF = async (certificate: TcMain) => {
  ...
  if (lotDetailsArray.length > 0 && allChemElements.length > 0) {
    ...
    doc.autoTable({
        ...
        styles: { lineWidth: 0.4, font: 'times', fontSize: 8, cellPadding: { top: 0.6, bottom: 0.6, left: 1, right: 1 }, halign: 'center', textColor: [0, 0, 0], lineColor: [0, 0, 0] },
        headStyles: { font: 'times', fontStyle: 'bold', fillColor: [255, 255, 255], textColor: [0, 0, 0], halign: 'center', valign: 'middle', fontSize: 8, cellPadding: { top: 0.7, bottom: 0.7, left: 1, right: 1 }, lineColor: [0, 0, 0] },
  ...
  if (labBody.length > 0) {
    doc.autoTable({
      ...
      styles: { lineWidth: 0.4, font: 'times', fontSize: 8, cellPadding: { top: 0.6, bottom: 0.6, left: 1, right: 1 }, halign: 'center', valign: 'middle', textColor: [0, 0, 0], lineColor: [0, 0, 0] },
      headStyles: { font: 'times', fontStyle: 'bold', fillColor: [255, 255, 255], textColor: [0, 0, 0], halign: 'center', valign: 'middle', fontSize: 8, cellPadding: { top: 0.7, bottom: 0.7, left: 1, right: 1 }, lineColor: [0, 0, 0] },
      columnStyles: {
  ...
  doc.autoTable({
    ...
    tableWidth: contentWidth,
    margin: { left: leftMargin, right: rightMargin },
    styles: { lineWidth: 0.4, font: 'times', fontSize: 8, cellPadding: { top: 0.6, bottom: 0.6, left: 1, right: 1 }, halign: 'left', textColor: [0, 0, 0], lineColor: [0, 0, 0] },
    headStyles: {
      fontStyle: 'bold',
      fillColor: [255, 255, 255],
      textColor: [0, 0, 0],
